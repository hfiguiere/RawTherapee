...
void Options::updatePaths()
{
    ...
    if (lastlocalCurvesDirghs.empty() || !Glib::file_test(lastlocalCurvesDirghs, Glib::FileTest::EXISTS) || !Glib::file_test(lastlocalCurvesDirghs, Glib::FileTest::IS_DIR)) {
    ...
    if (lastIcmCurvesDir.empty() || !Glib::file_test(lastIcmCurvesDir, Glib::FileTest::EXISTS) || !Glib::file_test(lastIcmCurvesDir, Glib::FileTest::IS_DIR)) {
